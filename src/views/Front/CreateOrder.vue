  ...
  <div>
    ...
    <div class="table-responsive" v-if="step === 1">
      ...
      <div class="input-group mb-4">
        <input type="text" class="form-control" placeholder="請輸入woolife" v-model="couponCode">
        <div class="input-group-append" @click.prevent="addCouponCode">
          <button class="btn btn-info" type="button">套用折價卷</button>
        </div>
      </div>
      <div class="mb-4 stepBtn">
        ...
        <a href="#" class="btn btn-primary d-inline-block" @click.prevent="step = 2">
          下一步，填寫訂購資料
    ...
    <div v-if="step === 2" class="mb-4">
      ...
      <div>
        ...
        <form @submit.prevent="createOrder">
          ...
          <div class="stepBtn">
            <a href="#" class="btn btn-secondary" @click.prevent="step = 1">
              <i class="fas fa-arrow-left"></i>
              回上一步
            </a>
