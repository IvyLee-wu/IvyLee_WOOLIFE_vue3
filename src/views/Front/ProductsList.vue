    ...
    <div class="row mb-2">
      ...
      <div class="col-lg-10 col-md-9">
        <div class="mb-2 text-left text-muted" v-if="filterText">
          {{ filterProducts.length }} result for "{{ filterText }}"
        </div>

        <div class="card-columns">
          <div class="card text-dark product-card"
           v-for="product in filterProducts" :key="product.id">
            ...
            <div class="product-more">
              ...
              <a href="#" class="text-info" @click.prevent="addToCart(product.id)">
                加到購物車
              </a>
            </div>
...
.product-soldout {
  ...
  background-color: rgba($hot-color, .3);
}
