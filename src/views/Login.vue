<template>
  <div class="mt-5">
    ...
    <form class="form-signin" @submit.prevent="signin">
      ...
      <button class="btn btn-lg btn-primary btn-block mb-3" type="submit" onkeypress="if (event.keyCode == 13) _search();">Sign in</button>
      <p class="mb-1 text-muted">&copy; 2019</p>
      <router-link class="text-muted" to="/"> &larr; Return to WOOLIFE</router-link>
    </form>
  </div>
</template>
